function [Overlap_Area,min_cut_off]  = hist_wss_idiff(corr_mat,ses,d,min_cut_off)%Overlapp_Area %[max_bss,min_wss]

%% Input
%           corr_mat = Identifiability matrix 
...
cutoff = min_wss:0.001:max_bss;                    % We will search the cutoff that gives the minimum error in this range
else 
