...
close all;
clc
addpath('D:\codes\dynamic_idiff_codes_amico\Dynamic_fingerprints-main')
...
configs.numSubj = 99; % Number of sampled subjects      
...
if flags.ComputeIdent==1
    ...
    for t=1:n_wsize
        ...
        configs.fMRI_file = 'HCP_un_related_100_amico_preprocesss400_hcp_sub_run_1_encode_LR_reg_ts.mat';%'FCs_10S_R1_LR.mat'
        % create dynamic functional connectomes at specific time scale t
        dFCw_2D_Test_LR = f_create_dFC_data(configs);
        configs.fMRI_file = 'HCP_un_related_100_amico_preprocesss400_hcp_sub_run_2_encode_LR_reg_ts.mat';%'FCs_10S_R2_LR.mat';       
        dFCw_2D_Retest_LR = f_create_dFC_data(configs);
        configs.fMRI_file = 'HCP_un_related_100_amico_preprocesss400_hcp_sub_run_1_encode_RL_reg_ts.mat';%'FCs_10S_R1_RL.mat';
        dFCw_2D_Test_RL = f_create_dFC_data(configs);
        configs.fMRI_file = 'HCP_un_related_100_amico_preprocesss400_hcp_sub_run_2_encode_RL_reg_ts.mat';%'FCs_10S_R2_RL.mat';       
...
sgtitle('Dynamic Identifiability matrix');
