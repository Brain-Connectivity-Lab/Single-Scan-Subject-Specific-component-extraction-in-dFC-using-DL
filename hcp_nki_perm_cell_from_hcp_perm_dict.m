...
for i_net = 7%9:-1:1
    ...
    for ii = 1:11
        ...
        %test
        Sub_spec_test_1_nki = cobe_transform(vec_test_nki_1,cobe_dict(:,:,ii));                                    % the dictionary extracted from the training subjects.
        Sub_spec_test_2_nki = cobe_transform(vec_test_nki_2,cobe_dict(:,:,ii));
        ...
        save(fullfile(results_path,[char(net_names(i_net)),'_nki_' atlas_name '_test_from_hcp_perm_dict_new_acco.mat']),"Idiff_max_test_perm_nki",...  _cobe_perm_acco_idiff_weight_',num2str(w_idiff*100),'_max2.mat
